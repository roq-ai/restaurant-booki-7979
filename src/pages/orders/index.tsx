...
export function OrderListPage(props: OrderListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getOrders({
        relations: ['user_order_customer_idTouser', 'user_order_waiter_idTouser'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('user', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'user_order_waiter_idTouser',
          header: 'User Order Waiter Id Touser',
          accessorKey: 'user_order_waiter_idTouser',
          cell: ({ row: { original: record } }: any) => (
            <Link
              as={NextLink}
              onClick={(e) => e.stopPropagation()}
              href={`/users/view/${record.user_order_waiter_idTouser?.id}`}
            >
              {record.user_order_waiter_idTouser?.email}
            </Link>
          ),
        }
      : null,
