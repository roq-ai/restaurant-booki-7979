...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`Restaurant booking and order taking system`}</title>

        <meta
          name="description"
          content="Restaurant booking and order taking system - Elevating dining experiences with seamless table reservations, efficient order management, and real-time updates. A comprehensive solution for restaurant management."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1551632436-cbf8dd35adfa?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxyZXN0YXVyYW50JTIwbWFuYWdlbWVudHxlbnwwfHx8fDE2OTUzNjIxNjB8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            <Heading mb={{ base: '12px', lg: '20px' }} size="2xl">
              {`Restaurant booking and order taking system`}
            </Heading>
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Restaurant booking and order taking system - Elevating dining experiences with seamless table reservations, efficient order management, and real-time updates. A comprehensive solution for restaurant management.`}
            </Text>
            <Box
